  ...
  return (
    ...
    <div className="container mx-auto h-full  flex items-center justify-center xl:justify-start">
      ...
      <div className="xl:-ml-0 ms:-ml-12">
         ...
         >
            <p className="xl:text-xl w-full md:text-[1rem]  sm:text-[.9rem] xs:text-[.9rem] ms:-ml-[3.3rem] ms:text-[.75rem] ms:w-[358px] xl:w-[1263px] xl:-ml-0  ms:mt-6 text-gray-200 text-justify mb-8">
