...
const VideoComponent = ({ videoId }) => {
  ...
  return (
    <section id='videos' className='w-full h-[60vh] xs:h-[800px] md:h-[90vh] ms:h-[1600px] top-0 flex items-center justify-center mt-10 bg-slate-700'>
        <div className='w-full items-center justify-center mx-auto'>
            ...
            <motion.div 
                ...
                className='items-center justify-center flex gap-8 xs:flex-col ms:flex-col ms:w-[380px] ms:h-[1200px] ms:mt-10 ms:ml-[1.5%]  md:flex-col md:w-full md:h-full md:ml-0 xl:w-[1270px] xl:mt-16 xl:ml-[15.5%] xs:w-[50px] xs:h-[30%] xs:ml-[50%]'>
                <iframe
                    width="100%"
                    height="315"
                    src={videoUrl1}
